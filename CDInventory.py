...
class DataProcessor:
    ...
    def user_input_proc():
        ...
        intID = int(user_lst[0])
        dicRow = {'ID': intID, 'Title': user_lst[1], 'Artist': user_lst[2]}
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        """
        Function to save cd inventory from memory to file
...
class IO:
    ...
    def user_input():
        ...
        user_lst = [strID, strTitle, stArtist]
        return user_lst
